...
def predict():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            labels_kebersihan = kebersihan_df['label'].value_counts(
            ).index.tolist()
            ...
            return render_template('predict/result_csv.html',
                                   labels_kebersihan=labels_kebersihan, counts_kebersihan=counts_kebersihan,
                                   labels_service=labels_service, counts_service=counts_service,
                                   labels_linen=labels_linen, counts_linen=counts_linen)
